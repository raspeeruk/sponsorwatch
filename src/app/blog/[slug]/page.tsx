    ...
    <article className="container-main py-12">
      ...
      <div className="mt-14 max-w-5xl">
        <EntrySection
          ...
          description="Records appearing in the register during the captured week."
          entries={post.gained}
          tone="status-A"
        />
        <EntrySection
          title="Sponsors lost"
          description="Records no longer appearing in the register during the captured week."
          entries={post.lost}
          tone="status-B"
        />
        ...
        {post.other_rating_changes.length > 0 && (
          <TransitionSection title="Other rating field changes" entries={post.other_rating_changes} tone="status-Provisional" />
        )}
        <section className="mt-14 border-t border-ink pt-6 max-w-2xl">
          ...
          <p className="mt-3">
            These are field-level corrections such as county text changes. They are counted here for completeness, but are not presented as sponsor status moves.
          </p>
